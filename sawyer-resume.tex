    ...
    \resumeSubheading
      ...
      {Bachelor of Science in \textbf{Computer Science and Math} Major GPA: 3.8/4.0, Dean's List}{}
        ...
        % Discrete Mathematics (c), Data Structures/Program Development(c), 
            \item[--] \textbf{Relevant Coursework:} User-Cent. Research & Evaluation (TA), Discrete Mathematics (c), Data Structures/Program Development (c), Differential Equations (c), Principles of Computer Science, and Introduction to Computer Science
        \end{itemize}
    \vspace{-5pt}
    \resumeSubheading
