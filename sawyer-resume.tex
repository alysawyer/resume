...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      \setlength\itemsep{0em}
          ...
          \item[--] Increasing performance of large language models on Latin by ~25\% and fine-tuned OpenAI's Davinci model utilizing its API. 
          \item[--] Decreased API usage cost by 70x in the pipeline to compare baseline model performance compared to our models through calculating the lowest perplexity option of multiple choice quiz questions.
      \end{itemize}
