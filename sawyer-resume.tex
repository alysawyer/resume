...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in \textbf{Computer Science and Math}, Major GPA: 3.6, Dean's List}{}
        \begin{itemize}\small
        \setlength\itemsep{0em}
        % Discrete Mathematics (c), Data Structures/Program Development(c), 
            \item[--] \textbf{Relevant Coursework:} User Experience Research and Evaluation (TA), Data Structures/Program Development, Principles of Computer Science, Discrete Mathematics, Introduction to Computer Science.
...
\section{Professional Experience}
  ...
  \section{Research Experience}
    \resumeSubHeadingListStart
      \resumeSubheading
        {Artificial Intelligence Researcher}{Anticipated Start: January 2024}
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \begin{itemize}\small
    \setlength\itemsep{0em}
      \item[--] P-recipe: Managing a team of 4, fully designed a computer vision project with transfer learning using ResNet with PyTorch.
