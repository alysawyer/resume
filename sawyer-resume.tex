    ...
    \resumeSubheading
      ...
      {Bachelor of Science in \textbf{Computer Science and Math}, Major GPA: 3.8, Dean's List}{}
        ...
        % Discrete Mathematics (c), Data Structures/Program Development(c), 
            \item[--] \textbf{Relevant Coursework:} Computability and Logic, Mathematical Analysis, Probability and Statistics, User Research and Evaluation (TA), Data Structures/Program Development, Principles of Computer Science, Discrete Mathematics.
...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      \resumeSubheading
      {Machine Learning Researcher}{January 2024 - Present}
...
\section{Awards}
    ...
    \resumeProjectHeading
          ...
          \resumeProjectHeading
          {\textbf{Nonprofit Founder} $|$ \emph{Founded and ran 2-week debate camp nonprofit for 200+ underprivileged debaters during COVID-19 for three years.}}{}
...
\begin{itemize}[leftmargin=0.15in, label={}]
   \small{\item{
    \textbf{Skills:}{ Python, Java, C++, Javascript, HTML, CSS, R, $\LaTeX$, Hugo, WordPress, Matplotlib, Pytorch, Arduino, Microsoft Office.} \\
