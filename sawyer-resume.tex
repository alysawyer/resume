...
\begin{center}
    ...
    \faPhone{} \href{Tel:650-395-7429}{(650) 395-7429} $\quad$
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Proficent:}{ Java, Python, C++, Javascript, HTML, CSS, R, $\LaTeX$, Hugo, WordPress, Matplotlib, Pytorch, Arduino, Microsoft Office} \\
